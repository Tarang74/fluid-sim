...
export default function SimCanvas() {
  const { simId, simMetadata, simWorker, simPaused, toggleSim, stepSim } =
    useSim();
  ...
  return (
    <div className="canvas">
      ...
      <div
        className={`sim-play-button ${true ? "visible" : "hidden"}`}
        onClick={() => {
          toggleSim();
        }}
      >
      ...
      <div
        className={`sim-step-button ${true ? "visible" : "hidden"}`}
        onClick={() => {
          stepSim();
        }}
      >
